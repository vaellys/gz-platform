...
<script type="text/javascript">
		   ...
		   var lrBarIconData={
			   'app0':{
					   'title':'门户首页',
					   'url':'http://10.0.200.103',
					   'winWidth':1100,
					   'winHeight':650
					   },
				'app1':{
					   'title':'资源云',
					   'url':'http://10.0.200.107:8081/',
					   'winWidth':1100,
					   'winHeight':650
					   },
				'app2':{
					   'title':'校园平台',
					   'url':'http://10.0.200.119/',
					   'winWidth':1100,
					   'winHeight':650
					   }
		   };
...
<div id="lr_bar">
  <ul id="default_app">
	   ...
	   <li id="app2"><span><img src="${ctx}/theme/desktop/icon/icon3.png" title="校园平台"/></span><div class="text">校园平台<s></s></div></li>
  </ul>
